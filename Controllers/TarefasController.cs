...
namespace TaskVerso.Controllers
{
    public class TarefasController : Controller
    {
        ...
        {
            var contexto = _context.Tarefas.Include(t => t.Prioridade);
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Status,prioridadeId")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Status,prioridadeId")] Tarefa tarefa)
        {
            if (id != tarefa.Id)
            {
                return NotFound();
